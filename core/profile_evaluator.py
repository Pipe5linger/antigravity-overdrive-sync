...
class ProfileEvaluator:
    ...
    def evaluate_session(self, db, session_id):
        ...
        prompt_instructions = (
            ...
            "1. Milestones: Major tasks completed, tools successfully set up, or skills mastered (e.g., 'Mastered VSCode search hotkeys').\n"
           ...
           "- 'confidence': A float score between 0.1 and 1.0 representing your certainty of this assessment.\n"
            "Be highly critical, technical, and objective. Only catpure metrics that are explicitly evidenced in the text.\n"
