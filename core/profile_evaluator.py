...
class ProfileEvaluator:
    ...
    async def evaluate_dialogue(self, dialogue_text, db=None, session_id=None, project_tag=None):
        ...
        prompt_instructions = (
            ...
            "CRITICAL DIRECTIVES:\n"
            "- NEVER alter, summarize, or discard Vespera's core persona matrix, physical baseline data, or narrative lore.\n"
            "- Write descriptions in a sharp, concise, non-corporate tone, focusing strictly on tactical developer intelligence.\n"
