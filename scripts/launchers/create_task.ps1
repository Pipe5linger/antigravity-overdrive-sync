$actionSync = New-ScheduledTaskAction -Execute 'wscript.exe' -Argument '"D:\AI\Projects\antigravity-overdrive-sync\scripts\launchers\sync_silent.vbs"'
...
$actionDaemon = New-ScheduledTaskAction -Execute 'wscript.exe' -Argument '"D:\AI\Projects\antigravity-overdrive-sync\scripts\launchers\daemon_silent.vbs"'
